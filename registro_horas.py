...
if not st.session_state.autenticado:
    ...
    with st.form("registro_form"):
        ...
        if enviar:
            ...
            guardar_registro((usuario, fecha.isoformat(), tipo, horas, proyecto, comentario, monto))

    df = cargar_registros(None if usuario.lower() == "soledad" else usuario)
    ...
    if not df.empty:
        ...
        if usuario.lower() == "soledad":
            ...
            df_usuario = df  # Soledad ve todos los registros
            ...
            # Botón de descarga Excel (mes actual)
            ...
            # Botón de descarga Excel (todos los datos)
